...
class Menu {
	public:
		...
		void callbackEstudiantes(int Posicion, vector<Estudiante>* Estudiantes); // Función callback para los Estudiantes (Ver Notas)
		void callbackProfesores(string Materia, int Nota, int Posicion, vector<Estudiante>* Estudiantes); // Función callback para los Profesores (Ingresar Notas)

		// Sobrecargas de las Funciones para la compatibilidad con los callbacks:
		void print_CalificacionesCallback(string Nombre, string Apellido, int Edad, vector<Estudiante>* Estudiantes, void (Menu:: *callback)(int, vector<Estudiante>*));
		void ingresar_CalificacionCallback(string Nombre, string Apellido, int Edad, string Materia, int Nota, vector<Estudiante>* Estudiantes, void (Menu:: *callback)(string, int, int, vector<Estudiante>*));
