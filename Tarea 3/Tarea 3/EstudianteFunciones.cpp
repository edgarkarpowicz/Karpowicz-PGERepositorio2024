...
vector<pair<string, int>> Estudiante::getCalificaciones() {
...
void Estudiante::eraseCalificacion(int dondeBorrar) {
	Calificaciones.erase(Calificaciones.begin() + dondeBorrar);
}